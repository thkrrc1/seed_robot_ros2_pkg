...
def generate_launch_description():
    ...
    slam_localization_file = os.path.join(slam_toolbox_dir, 'launch', 'localization_launch.py')
    slam_merge_maps_kinematic_file = os.path.join(slam_toolbox_dir, 'launch', 'merge_maps_kinematic_launch.py')
    slam_offline_file = os.path.join(slam_toolbox_dir, 'launch', 'offline_launch.py')
    slam_online_async_file = os.path.join(slam_toolbox_dir, 'launch', 'online_async_launch.py')
    slam_online_sync_file = os.path.join(slam_toolbox_dir, 'launch', 'online_sync_launch.py')
