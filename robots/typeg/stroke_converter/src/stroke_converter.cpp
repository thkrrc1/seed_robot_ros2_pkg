...
void seed_converter::TypeG::makeTables() {
    upper_csv_dir = ament_index_cpp::get_package_share_directory("typeg") + "/csv/typeG_upperbody";
    lifter_csv_dir = ament_index_cpp::get_package_share_directory("typeg") + "/csv/typeG_lifter";
