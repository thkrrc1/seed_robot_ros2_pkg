...
class RobotState {
    public:
        ...
        bool set_position(const std::string &name, double value) {
        ...
        bool add_joint(const std::string &name, double value = JOINT_VALUE_INVALID) {
        ...
        double get_position(const std::string &jname) const{
