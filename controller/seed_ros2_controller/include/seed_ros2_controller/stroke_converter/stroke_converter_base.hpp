...
protected:
    ...
    DiffJoint setDualAngleToStroke(const float _r_angle, const float _p_angle, const std::vector<seed_converter::StrokeMap> &_r_table, const std::vector<seed_converter::StrokeMap> &_p_table,
