...
FUNCTION(ADD_FILES root_dir extension return_list)
    ...
    # buildディレクトリ配下を除外
    LIST(FILTER return_list_tmp EXCLUDE REGEX ".*/build/.*")
...
MACRO(INIT_PROJECT)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/config/version_config.hpp.in ${PROJECT_BINARY_DIR}/config/version_config.hpp)
    set(HEADER_DIRS ${HEADER_DIRS} ${PROJECT_BINARY_DIR}/config)
ENDMACRO()
